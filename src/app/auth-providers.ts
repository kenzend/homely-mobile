...
export function configureOAuthProviderIdentityServer(): TnsOaProvider {
    const identityServerProviderOptions: TnsOaProviderOptionsIdentityServer = {
      openIdSupport: 'oid-full',
      issuerUrl: 'https://homelyidentityprovider.azurewebsites.net',
      clientId: 'web-client',
      urlScheme: 'org.nativescript.teamhomely',
      redirectUri: 'https://teamhomely.azurewebsites.net/signin-callback',
      scopes: ['openid', 'profile', 'homelyAPI'],
    };
